...
public class ProdutoController {
	...
	public ResponseEntity<List<Produto>> getByIdPro(@PathVariable String idPro){
		return ResponseEntity.ok(produtoRepository.findAllByIdProContainingIgnoreCase(idPro));
	}
